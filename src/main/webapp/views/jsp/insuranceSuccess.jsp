...
<html>
	...
	<title>支付详情界面</title>
	<link type="text/css" rel="stylesheet" href="<%=path %>/views/css/style_pc.css">
	

	<script type="text/javascript" src="<%=path %>/views/js/swiper-3.4.0.min.js"></script>
	<script src="<%=path%>/views/js/jquery-1.9.0.min.js"></script>
	<script src="<%=path%>/views/js/js.js"></script>
</head>
...
<div class="div640">
    <div class="div600 index7">
	     <div class="ul_bei">
		  <img src="<%=path%>/views/image/zhifu.png">
		    <ul class="ul_a">
     ...
     <div class="clear"></div>
	     ...
	     <div class="content9 boder1">
		     <div class="content8">
		        <div class="logo"><img src="<%=path%>/views/image/index8_2.png"></div>
		      ...
		      <p class="con3_p7 "><a href="<%=path%>/views/jsp/quickSurehome.jsp?orderNo=${insuranceDetailsVO.baseinfor.orderno}">返回首页</a></p>
		     </div>
	     </div>
