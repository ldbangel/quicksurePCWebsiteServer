    ...
    calendar: function(c) {
        function r() {
            $("#" + c.controlId).find(".tabD a").mouseup(function() {
                ...
                n.val(a);
                if(c.controlId=='divDate'){var jqradio=$('#jqradio');jqradio.attr('checked','checked');jqradio.parent().addClass('sel_on');jqradio.parent().siblings('label').children("input").removeAttr("checked");jqradio.parent().siblings('label').removeClass('sel_on');};
                if(c.controlId=='Datediv'){var td_Is=$("#td_Is");td_Is.attr('checked','checked');td_Is.parent().addClass('sel_on');td_Is.parent().siblings('label').children("input").removeAttr("checked");td_Is.parent().siblings('label').removeClass('sel_on');}
                if($('#td_Is').attr('checked')=="checked"){
                	if($('#SY_DATE').val()==null||$('#SY_DATE').val()==''){
                		$('#SY_DATE').val(a);
                	}
                	};
        ...
        function() {
            if ($("#" + c.controlId + ":hidden").length != 0) {
              ...
              /*  var lf= $("#info_box").offset.left;
                var top= $("#info_box").offset.top;*/
                a.css({
                    top: b + "px",
                    left: d + "px"
                });
